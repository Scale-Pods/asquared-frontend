            ...
            <aside className="w-72 flex-col bg-[#000000] border-r border-zinc-800 hidden md:flex font-sans">
                ...
                <div className="px-6 py-6">
                    {mounted ? (
                            ...
                            <DropdownMenuTrigger asChild>
                                ...
                                >
                                    <span className="flex items-center gap-3">
                                        ...
                                        <span className="font-semibold text-sm truncate uppercase tracking-wider">Email Marketing</span>
                                    </span>
                        ...
                        <Button
                            variant="outline"
                            className="w-full justify-between bg-zinc-900 border-zinc-800 text-zinc-700 h-11 shadow-sm opacity-50"
                        >
